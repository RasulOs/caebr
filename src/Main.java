...
//        System.out.println(matrix2.zScoreStandardization());
        ...
        StandardVector<Integer> vectorForMult1 = new StandardVector<>(new Integer[] {1, 2, 3}, false);
        StandardVector<Integer> vectorForMult2 = new StandardVector<>(new Integer[] {4, 5, 6});

        System.out.println(
                vectorForMult1.multiply(vectorForMult2)
                        .transpose()
        );
    }
}
